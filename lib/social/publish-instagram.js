...
import { INSTAGRAM_PILOT_SOURCE_ID, instagramPilotWriteGate } from './write-gates.js';
...
export function evaluateInstagramPilot(packageValue, source, meta, delivery) {
  ...
  const checks = [
    check('PILOT_SOURCE', packageValue?.sourceType === 'music_release' && packageValue?.sourceId === INSTAGRAM_PILOT_SOURCE_ID, 'Este piloto está restrito ao release autorizado.'),
