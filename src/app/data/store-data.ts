...
export const ALL_PRODUCTS: Product[] = [
  ...
  },
  {
    id: 'wine-reserva',
    faction: 'tech-lead',
    image: 'assets/store/wine-rio-sol.jpg', // Gere uma imagem de garrafa chique depois!
    stripeUrl: 'https://amzn.to/3LX0doE',
    content: {
      pt: { name:'CODE RED: RESERVA Alicante Bouschet // Ouro do Sertão', description: 'Produzido no Vale do Silício do Sertão. Notas de frutas negras, chocolate amargo e persistência para aguentar deploy de sexta-feira.' ,price:"" },
      en: { name:'CODE RED: RESERVE Alicante Bouschet // Gold from the Sertão', description:'Produced in the Silicon Valley of the Sertão. Notes of dark fruits, dark chocolate, and enough persistence to withstand Friday deployments.' ,price:"" }
    },
    },
